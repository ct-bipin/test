  ...
  return (
    <MainCard title="Typography Component Showcase">
      <Stack sx={{gap:1}} >
        ...
        {/* Subtitles */}
        <Typography variant="subtitle1">subtitle1. Subtitle text</Typography>

        <Typography variant="subtitle2">subtitle2. Subtitle text</Typography>
        ...
        {/* Link (custom variant) */}
        <Typography variant="link">link. This is link text style</Typography>
      </Stack>
    </MainCard>
  );
}
